...
export default function CheckoutPage() {
    // const { courtId } = useParams() // Temporarily unused
    const [paymentMethod, setPaymentMethod] = useState("va")
    // const [vaBank, setVaBank] = useState("bca") // Temporarily unused
    // const [eWallet, setEWallet] = useState("gopay") // Temporarily unused
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="mb-8">
                <div className="text-sm text-gray-400 flex items-center gap-2 mb-2">
                    <Link to="/" className="hover:text-white">Jadwal</Link>
                    <span>&rsaquo;</span>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-[#16282a] border border-gray-800 rounded-2xl p-6 sticky top-24">
                        ...
                        <div className="flex gap-4 mb-6 pb-6 border-b border-gray-700 border-dashed">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-sm">Emerald Tennis Center</h3>
                                <div className="text-xs text-gray-400 mb-2">Lapangan Indoor 02</div>
                                <div className="inline-flex items-center px-2 py-1 rounded bg-[#0f2226] border border-gray-700 text-xs text-primary">
                        ...
                        {/* Promo Code */}
                        <div className="mb-6">
                            <label className="text-xs font-bold text-gray-400 mb-2 block uppercase">Kode Promo</label>
                            <div className="flex gap-2">
                                <input type="text" placeholder="Masukkan kode" className="flex-1 bg-[#0d1b1e] border border-gray-700 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-primary" />
                                <button className="px-4 py-2 bg-[#0f3535] text-primary border border-primary/30 rounded-lg text-sm font-bold hover:bg-primary hover:text-background transition-colors">
                                    Pakai
                                </button>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-end mb-8">
                            ...
                            <span className="text-3xl font-bold text-primary">Rp 505.000</span>
                        </div>

                        <Link to="/booking/success" className="w-full block bg-primary text-[#0a1a1a] text-center font-bold py-3.5 rounded-xl hover:bg-primary/90 transition-all shadow-[0_0_20px_rgba(0,214,181,0.3)]">
                            Bayar Sekarang
                        </Link>
                    </div>
                </div>
